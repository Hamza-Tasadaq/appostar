...
interface PrivacyModalProps {
    ...
    setIsAgreeWithPrivacy: Dispatch<SetStateAction<boolean>>
}

const PrivacyModal = ({ open, setOpen, setIsAgreeWithPrivacy }: PrivacyModalProps) => {
    return (
