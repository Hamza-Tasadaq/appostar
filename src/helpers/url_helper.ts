...
// WHICH WE USE
// export const VALIDATE_VAT_CODE = `https://apilayer.net/api/validate?access_key=${process.env.REACT_PUBLIC_API_LAYER_ACCESS_KEY!}`
export const VALIDATE_VAT_CODE = `https://apilayer.net/api/validate?access_key=d240cd5095c68ae91161a569b880932a`