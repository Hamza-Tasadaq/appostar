                ...
                <Row className="g-2 align-items-center">
                    ...
                    <Col className="col-sm-auto ms-auto">
                        <div className="list-grid-nav hstack gap-1">
                            <Button color='primary' id="grid-view-button" className="btn btn-soft-infos nav-link btn-icon fs-14 active filter-button material-shadow-none"><i className="ri-grid-fill fs-3"></i></Button>
                            <Button color='primary' id="list-view-button" className="btn btn-soft-infos nav-link btn-icon fs-14 active filter-button material-shadow-none"><i className="ri-list-unordered fs-3"></i></Button>
                            <FiltersDropdown />
                        </div>
                    </Col>
                </Row>
