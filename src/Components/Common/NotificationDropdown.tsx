    ...
    return (
        <React.Fragment>
            <Dropdown isOpen={isNotificationDropdown} toggle={toggleNotificationDropdown} className="topbar-head-dropdown ms-1 header-item">
                ...
                <DropdownMenu end={true} className="dropdown-menu-lg dropdown-menu-end full-screen-dropdown p-0">
                    ...
                    <TabContent className='full-height-tab-content' activeTab={activeTab}>
                        <TabPane tabId="1" className="py-2 ps-2">
                            <SimpleBar
                                className="pe-2 full-screen-dropdown">
                                        ...
                                        <div className="px-2 fs-15">
                                            ...
                                            <UncontrolledDropdown direction='start' className="col text-end">
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownItem className="dropdown-item remove-list" href="#removeMemberModal" onClick={() => { }}>
